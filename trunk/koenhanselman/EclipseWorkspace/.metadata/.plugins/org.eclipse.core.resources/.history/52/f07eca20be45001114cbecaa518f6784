...
public final class AProgramKickReach extends PProgramKickReach
{
    private TKickReach _kickReach_;
    private TEquals _equals_;
    private TDigit _digit_;
    private TNewline _newline_;

    public AProgramKickReach()
    {
        // Constructor
    }

    public AProgramKickReach(
        @SuppressWarnings("hiding") TKickReach _kickReach_,
        @SuppressWarnings("hiding") TEquals _equals_,
        @SuppressWarnings("hiding") TDigit _digit_,
        @SuppressWarnings("hiding") TNewline _newline_)
    {
        // Constructor
        setKickReach(_kickReach_);
    ...
    public Object clone()
    {
        return new AProgramKickReach(
            cloneNode(this._kickReach_),
    ...
    {
        ((Analysis) sw).caseAProgramKickReach(this);
    }

    public TKickReach getKickReach()
    {
        return this._kickReach_;
    }

    public void setKickReach(TKickReach node)
    {
        if(this._kickReach_ != null)
        {
            this._kickReach_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._kickReach_ == child)
        {
            this._kickReach_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._kickReach_ == oldChild)
        {
            setKickReach((TKickReach) newChild);
            return;
        }
