...
public class SAFLexer extends Lexer {
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:93:2: ( '0' .. '9' | '10' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // D:\\Master\\Software Construction\\ANTLR\\SAF.g:93:4: '0' .. '9'
                    {
                    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // D:\\Master\\Software Construction\\ANTLR\\SAF.g:94:4: '10'
                    {
                    match("10"); 
    ...
    public final void mWHITESPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:98:2: ( ( '\\t' | ' ' | '\\r' | '\\n' | '\\u000C' )+ )
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:98:4: ( '\\t' | ' ' | '\\r' | '\\n' | '\\u000C' )+
            {
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:98:4: ( '\\t' | ' ' | '\\r' | '\\n' | '\\u000C' )+
            int cnt2=0;
            loop2:
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:102:2: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ )
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:102:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+
            {
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:102:4: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+
            int cnt3=0;
            loop3:
