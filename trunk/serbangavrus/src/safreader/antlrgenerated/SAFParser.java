...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "fighter"
    // D:\\Master\\Software Construction\\ANTLR\\SAF.g:30:1: fighter returns [Fighter f] : STRING '{' (s= spec )+ '}' -> ^( STRING ( spec )+ ) '{' ;
    public final SAFParser.fighter_return fighter() throws RecognitionException {
        ...
        try {
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:31:2: ( STRING '{' (s= spec )+ '}' -> ^( STRING ( spec )+ ) '{' )
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:31:4: STRING '{' (s= spec )+ '}'
            {
            ...
            // D:\\Master\\Software Construction\\ANTLR\\SAF.g:33:6: (s= spec )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // D:\\Master\\Software Construction\\ANTLR\\SAF.g:33:7: s= spec
            	    {
            ...
            // 36:2: -> ^( STRING ( spec )+ ) '{'
            {
                // D:\\Master\\Software Construction\\ANTLR\\SAF.g:36:5: ^( STRING ( spec )+ )
                {
