...
/**
 * Contains all properties of a behaviour rule of a fighter bot
 **/
public class BehaviourRule {
    ...
    /**
     * Constructor for single condition rules
     */
    ...
    /**
     * Constructor for rules with OR or And
     */
    ...
    /**
     * Checks if this rule holds for the conditions of a bot
     * @param strengthCondition - strength condition of the bot
     * @param rangeCondition - range condition of the bot
     * @return true if the rule holds
     */
    public boolean ruleIsTrue(ConditionType strengthCondition, ConditionType rangeCondition) {
        if (logicalOperator == LogicalOperatorType.NONE) {
            return singleRuleIsTrue(firstCondition, strengthCondition, rangeCondition) ) {
                return true; 
            }
