...
public class FDLLexer extends Lexer {
	...
	public final void mALWAYS() throws RecognitionException {
		try {
			...
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:41:8: (
			// 'always' )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:41:10:
			// 'always'
			{
				match("always");
	...
	public final void mAND() throws RecognitionException {
		try {
			int _type = AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:38:5: (
			// 'and' )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:38:7:
			// 'and'
			{
				match("and");
	...
	public final void mCHOOSE() throws RecognitionException {
		try {
			int _type = CHOOSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:37:8: (
			// 'choose' )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:37:10:
			// 'choose'
			{
				match("choose");
	...
	public final void mIDENT() throws RecognitionException {
		try {
			int _type = IDENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:43:8: ( (
			// 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0'
			// .. '9' | '_' )* )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:43:10: (
			// 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0'
			// .. '9' | '_' )*
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:43:34:
				// ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
				loop3: do {
					int alt3 = 2;
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			int _type = INTEGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:36:9: ( (
			// '0' .. '9' )+ )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:36:11: (
			// '0' .. '9' )+
			{
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:36:11:
				// ( '0' .. '9' )+
	...
	public final void mOR() throws RecognitionException {
		try {
			int _type = OR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:39:4: (
			// 'or' )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:39:6:
			// 'or'
			{
				match("or");
	...
	public void mTokens() throws RecognitionException {
		// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:1:8: ( T__12
		// | T__13 | T__14 | T__15 | T__16 | T__17 | WS | INTEGER | CHOOSE | AND
		// | OR | ASSIGN | ALWAYS | IDENT )
		int alt4 = 14;
		switch (input.LA(1)) {
		case '(': {
			alt4 = 1;
					...
					if ((LA4_18 == 'o')) {
						...
						if ((LA4_22 == 's')) {
							...
							if ((LA4_25 == 'e')) {
								...
								if (((LA4_27 >= '0' && LA4_27 <= '9') || (LA4_27 >= 'A' && LA4_27 <= 'Z')
										|| LA4_27 == '_' || (LA4_27 >= 'a' && LA4_27 <= 'z'))) {
									alt4 = 14;
								} else {
									alt4 = 9;
								}
					...
					if ((LA4_20 == 'a')) {
						...
						if ((LA4_24 == 'y')) {
							...
							if ((LA4_26 == 's')) {
								...
								if (((LA4_28 >= '0' && LA4_28 <= '9') || (LA4_28 >= 'A' && LA4_28 <= 'Z')
										|| LA4_28 == '_' || (LA4_28 >= 'a' && LA4_28 <= 'z'))) {
									alt4 = 14;
								} else {
									alt4 = 13;
								}
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:35:4: ( (
			// ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+ )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:35:6: (
			// ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+
			{
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:35:6:
				// ( ' ' | '\\t' | '\\r' | '\\n' | '\\f' )+
