...
public class FDLParser extends Parser {
	...
	public static final BitSet FOLLOW_characteristic_in_fighterAttribute487 = new BitSet(
	...
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ALWAYS", "AND",
			"ASSIGN", "CHOOSE", "IDENT", "INTEGER", "OR", "WS", "'('", "')'", "'['", "']'", "'{'", "'}'" };
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:83:1: behaviour
	// returns [Behaviour result] : ( conditionOr '[' rule ']' | ALWAYS '[' rule
	// ']' );
	public final Behaviour behaviour() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:84:3: (
			// conditionOr '[' rule ']' | ALWAYS '[' rule ']' )
			int alt7 = 2;
			...
			switch (alt7) {
			case 1:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:84:5:
			// conditionOr '[' rule ']'
			{
				...
				break;
			case 2:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:85:5:
			// ALWAYS '[' rule ']'
			{
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:45:1:
	// characteristic returns [Characteristic result] : IDENT ASSIGN INTEGER ;
	public final Characteristic characteristic() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:46:3: (
			// IDENT ASSIGN INTEGER )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:46:5:
			// IDENT ASSIGN INTEGER
			{
				...
				result = new Characteristic((IDENT1 != null ? IDENT1.getText() : null),
						(INTEGER2 != null ? INTEGER2.getText() : null));
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:49:1:
	// conditionAnd returns [ConditionAnd result] : op1= IDENT ( AND oprest=
	// IDENT )* ;
	public final ConditionAnd conditionAnd() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:53:3:
			// (op1= IDENT ( AND oprest= IDENT )* )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:53:5:
			// op1= IDENT ( AND oprest= IDENT )*
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:53:42:
				// ( AND oprest= IDENT )*
				loop1: do {
					int alt1 = 2;
					...
					switch (alt1) {
					case 1:
					// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:53:43:
					// AND oprest= IDENT
					{
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:56:1: conditionOr
	// returns [ConditionOr result] : op1= conditionAnd ( OR oprest=
	// conditionAnd )* ;
	public final ConditionOr conditionOr() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:60:3:
			// (op1= conditionAnd ( OR oprest= conditionAnd )* )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:60:5:
			// op1= conditionAnd ( OR oprest= conditionAnd )*
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:60:51:
				// ( OR oprest= conditionAnd )*
				loop2: do {
					int alt2 = 2;
					...
					switch (alt2) {
					case 1:
					// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:60:52:
					// OR oprest= conditionAnd
					{
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:71:1: fightChoice
	// returns [FightChoice result] : ( CHOOSE '(' ( IDENT )+ ')' | IDENT );
	public final FightChoice fightChoice() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:75:3: (
			// CHOOSE '(' ( IDENT )+ ')' | IDENT )
			int alt6 = 2;
			...
			switch (alt6) {
			case 1:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:75:5:
			// CHOOSE '(' ( IDENT )+ ')'
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:75:16:
				// ( IDENT )+
				int cnt5 = 0;
				loop5: do {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:75:17:
					// IDENT
					{
				...
				break;
			case 2:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:76:5:
			// IDENT
			{
	...
	// $ANTLR start "fighter"
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:93:1: fighter
	// returns [Fighter result] : IDENT '{' ( fighterAttribute )* '}' ;
	public final Fighter fighter() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:97:3: (
			// IDENT '{' ( fighterAttribute )* '}' )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:97:5:
			// IDENT '{' ( fighterAttribute )* '}'
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:97:15:
				// ( fighterAttribute )*
				loop9: do {
					int alt9 = 2;
					...
					switch (alt9) {
					case 1:
					// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:97:16:
					// fighterAttribute
					{
	...
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:88:1:
	// fighterAttribute returns [FighterAttribute result] : ( characteristic |
	// behaviour );
	public final FighterAttribute fighterAttribute() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:89:3: (
			...
			switch (alt8) {
			case 1:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:89:5:
			// characteristic
			{
				...
				break;
			case 2:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:90:5:
			// behaviour
			{
	...
	public String getGrammarFileName() {
		return "C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g";
	}
	public String[] getTokenNames() {
		return FDLParser.tokenNames;
	}
	// $ANTLR start "moveChoice"
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:63:1: moveChoice
	// returns [MoveChoice result] : ( CHOOSE '(' ( IDENT )+ ')' | IDENT );
	public final MoveChoice moveChoice() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:67:3: (
			// CHOOSE '(' ( IDENT )+ ')' | IDENT )
			int alt4 = 2;
			...
			switch (alt4) {
			case 1:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:67:5:
			// CHOOSE '(' ( IDENT )+ ')'
			{
				...
				// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:67:16:
				// ( IDENT )+
				int cnt3 = 0;
				loop3: do {
					int alt3 = 2;
					...
					switch (alt3) {
					case 1:
					// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:67:17:
					// IDENT
					{
				...
				break;
			case 2:
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:68:5:
			// IDENT
			{
	...
	// $ANTLR start "parse"
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:100:1: parse
	// returns [ITreeNode tree] : fighter EOF ;
	public final ITreeNode parse() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:101:3: (
			// fighter EOF )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:101:5:
			// fighter EOF
			{
	...
	// $ANTLR start "rule"
	// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:79:1: rule
	// returns [Rule result] : moveChoice fightChoice ;
	public final Rule rule() throws RecognitionException {
		...
		try {
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:80:3: (
			// moveChoice fightChoice )
			// C:\\Repositories\\SoftwareConstruction\\SAF\\src\\FDL.g:80:5:
			// moveChoice fightChoice
			{
