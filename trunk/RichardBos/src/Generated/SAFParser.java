...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final SAFParser.bot_return bot() throws RecognitionException {
        ...
        try {
            ...
            char_literal1=(Token)match(input,17,FOLLOW_17_in_bot169); 
            char_literal1_tree = 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_behavior_in_bot182);
            	    b=behavior();
            	...
            	case 2 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_characteristic_in_bot217);
            	    c=characteristic();
            ...
            char_literal2=(Token)match(input,18,FOLLOW_18_in_bot249); 
            char_literal2_tree = 
    ...
    public final SAFParser.name_return name() throws RecognitionException {
        ...
        try {
            ...
            ID3=(Token)match(input,ID,FOLLOW_ID_in_name266); 
            ID3_tree = 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_subname_in_name310);
            	    sn=subname();
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    ID4=(Token)match(input,ID,FOLLOW_ID_in_subname357); 
                    ID4_tree = 
                ...
                case 2 :
                    ...
                    {
                    INT5=(Token)match(input,INT,FOLLOW_INT_in_subname398); 
                    INT5_tree = 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:47:3: ID
            	    {
            	    ID6=(Token)match(input,ID,FOLLOW_ID_in_characteristic449); 
            	    ID6_tree = 
            ...
            char_literal7=(Token)match(input,14,FOLLOW_14_in_characteristic452); 
            char_literal7_tree = 
            ...
            INT8=(Token)match(input,INT,FOLLOW_INT_in_characteristic454); 
            INT8_tree = 
    ...
    public final SAFParser.behavior_return behavior() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_condition_in_behavior497);
            c=condition();
            ...
            char_literal9=(Token)match(input,15,FOLLOW_15_in_behavior500); 
            char_literal9_tree = 
            ...
            switch (alt7) {
                case 1 :
                    ...
                    {
                    id1=(Token)match(input,ID,FOLLOW_ID_in_behavior574); 
                    id1_tree = 
                ...
                case 2 :
                    ...
                    {
                    CHOOSE10=(Token)match(input,CHOOSE,FOLLOW_CHOOSE_in_behavior609); 
                    CHOOSE10_tree = 
                    ...
                    char_literal11=(Token)match(input,12,FOLLOW_12_in_behavior612); 
                    char_literal11_tree = 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    c1=(Token)match(input,ID,FOLLOW_ID_in_behavior655); 
                    	    c1_tree = 
                    ...
                    char_literal12=(Token)match(input,13,FOLLOW_13_in_behavior704); 
                    char_literal12_tree = 
            ...
            switch (alt9) {
                case 1 :
                    ...
                    {
                    id2=(Token)match(input,ID,FOLLOW_ID_in_behavior721); 
                    id2_tree = 
                ...
                case 2 :
                    ...
                    {
                    CHOOSE13=(Token)match(input,CHOOSE,FOLLOW_CHOOSE_in_behavior756); 
                    CHOOSE13_tree = 
                    ...
                    char_literal14=(Token)match(input,12,FOLLOW_12_in_behavior759); 
                    char_literal14_tree = 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    {
                    	    c2=(Token)match(input,ID,FOLLOW_ID_in_behavior803); 
                    	    c2_tree = 
                    ...
                    char_literal15=(Token)match(input,13,FOLLOW_13_in_behavior852); 
                    char_literal15_tree = 
            ...
            char_literal16=(Token)match(input,16,FOLLOW_16_in_behavior860); 
            char_literal16_tree = 
    ...
    // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:75:1: condition returns [Condition condition] : cr1= conditionRule ( OR cr2= conditionRule )* ;
    public final SAFParser.condition_return condition() throws RecognitionException {
        ...
        try {
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:75:40: (cr1= conditionRule ( OR cr2= conditionRule )* )
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:76:4: cr1= conditionRule ( OR cr2= conditionRule )*
            {
            root_0 = (CommonTree)adaptor.nil();


            pushFollow(FOLLOW_conditionRule_in_condition876);
            cr1=conditionRule();
            ...
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:78:4: ( OR cr2= conditionRule )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:78:6: OR cr2= conditionRule
            	    {
            	    OR17=(Token)match(input,OR,FOLLOW_OR_in_condition904); 
            	    OR17_tree = 
            	    ...
            	    pushFollow(FOLLOW_conditionRule_in_condition908);
            	    cr2=conditionRule();
    ...
    // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:82:1: conditionRule returns [Condition condition] : v1= var ( AND v2= var )* ;
    public final SAFParser.conditionRule_return conditionRule() throws RecognitionException {
        ...
        try {
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:82:44: (v1= var ( AND v2= var )* )
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:83:4: v1= var ( AND v2= var )*
            {
            root_0 = (CommonTree)adaptor.nil();


            pushFollow(FOLLOW_var_in_conditionRule949);
            v1=var();
            ...
            // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:85:4: ( AND v2= var )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // C:\\Dropbox\\EclipseWorkSpace\\SAF\\SuperAwesomeFighters\\Grammar\\SAF.g:85:6: AND v2= var
            	    {
            	    AND18=(Token)match(input,AND,FOLLOW_AND_in_conditionRule988); 
            	    AND18_tree = 
            	    ...
            	    pushFollow(FOLLOW_var_in_conditionRule992);
            	    v2=var();
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    ID19=(Token)match(input,ID,FOLLOW_ID_in_var1041); 
                    ID19_tree = 
                ...
                case 2 :
                    ...
                    char_literal20=(Token)match(input,12,FOLLOW_12_in_var1084); 
                    char_literal20_tree = 
                    ...
                    pushFollow(FOLLOW_condition_in_var1088);
                    c=condition();
                    ...
                    char_literal21=(Token)match(input,13,FOLLOW_13_in_var1090); 
                    char_literal21_tree = 
    ...
    public static final BitSet FOLLOW_name_in_bot130 = new BitSet(new long[]{0x0000000000020000L});
    public static final BitSet FOLLOW_17_in_bot169 = new BitSet(new long[]{0x0000000000001100L});
    public static final BitSet FOLLOW_behavior_in_bot182 = new BitSet(new long[]{0x0000000000041100L});
    public static final BitSet FOLLOW_characteristic_in_bot217 = new BitSet(new long[]{0x0000000000041100L});
    public static final BitSet FOLLOW_18_in_bot249 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_name266 = new BitSet(new long[]{0x0000000000000302L});
    public static final BitSet FOLLOW_subname_in_name310 = new BitSet(new long[]{0x0000000000000302L});
    ...
    public static final BitSet FOLLOW_ID_in_characteristic449 = new BitSet(new long[]{0x0000000000004100L});
    public static final BitSet FOLLOW_14_in_characteristic452 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_INT_in_characteristic454 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_condition_in_behavior497 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_15_in_behavior500 = new BitSet(new long[]{0x0000000000000140L});
    public static final BitSet FOLLOW_ID_in_behavior574 = new BitSet(new long[]{0x0000000000000140L});
    public static final BitSet FOLLOW_CHOOSE_in_behavior609 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_behavior612 = new BitSet(new long[]{0x0000000000002100L});
    public static final BitSet FOLLOW_ID_in_behavior655 = new BitSet(new long[]{0x0000000000002100L});
    public static final BitSet FOLLOW_13_in_behavior704 = new BitSet(new long[]{0x0000000000000140L});
    public static final BitSet FOLLOW_ID_in_behavior721 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_CHOOSE_in_behavior756 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_behavior759 = new BitSet(new long[]{0x0000000000002100L});
    public static final BitSet FOLLOW_ID_in_behavior803 = new BitSet(new long[]{0x0000000000002100L});
    public static final BitSet FOLLOW_13_in_behavior852 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_16_in_behavior860 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_conditionRule_in_condition876 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_OR_in_condition904 = new BitSet(new long[]{0x0000000000001100L});
    public static final BitSet FOLLOW_conditionRule_in_condition908 = new BitSet(new long[]{0x0000000000000402L});
    public static final BitSet FOLLOW_var_in_conditionRule949 = new BitSet(new long[]{0x0000000000000012L});
    public static final BitSet FOLLOW_AND_in_conditionRule988 = new BitSet(new long[]{0x0000000000001100L});
    public static final BitSet FOLLOW_var_in_conditionRule992 = new BitSet(new long[]{0x0000000000000012L});
    public static final BitSet FOLLOW_ID_in_var1041 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_12_in_var1084 = new BitSet(new long[]{0x0000000000001100L});
    public static final BitSet FOLLOW_condition_in_var1088 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_var1090 = new BitSet(new long[]{0x0000000000000002L});
