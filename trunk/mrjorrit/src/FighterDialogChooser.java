...
public class FighterDialogChooser {
	...
	public Fighter ChooseFighterFromDialog(String fighterPosition)
	...
	private void drawDialog(String fighterPosition) {
		while (selectedFighter == null || selectedFighter.isEmpty()) {
			selectedFighter = (String) JOptionPane.showInputDialog(null,
					"Choose a fighter..", fighterPosition,
					JOptionPane.PLAIN_MESSAGE, null, fighterFiles, 1);
		}
	}

	private Fighter createFighter() throws IOException, RecognitionException {
		FDLLexer lexer = new FDLLexer(new ANTLRFileStream("input/"
				+ selectedFighter));
		selectedFighter = "";
