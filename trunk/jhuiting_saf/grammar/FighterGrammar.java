...
public class FighterGrammar/*@bgen(jjtree)*/implements FighterGrammarTreeConstants, FighterGrammarConstants {/*@bgen(jjtree)*/
  ...
  final public SimpleNode parseFighterBasics() throws ParseException {
 /*@bgen(jjtree) FighterNode */
  ...
  final public void parseFighterStructure() throws ParseException {
 /*@bgen(jjtree) Fighter */
  ...
  final public void fighterOptions() throws ParseException {
    if (jj_2_1(2)) {
  ...
  final public void fighterPersonalityRule() throws ParseException {
 /*@bgen(jjtree) FighterPersonality */
  ...
  final public void fighterCharacteristicsRule() throws ParseException {
...
//}
 ...
 /*@bgen(jjtree) Assignment */
  ...
  final public void CharacteristicValue() throws ParseException {
 /*@bgen(jjtree) Number */
