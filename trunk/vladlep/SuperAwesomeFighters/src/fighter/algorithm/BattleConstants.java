...
public class BattleConstants {
	...
	public static final int minimDistance = 1;
	...
	public static final int jumpPosY = 50;
	public static final int crouchPosY = 10;

	public static final int defaulWalkTime = 1;
	public static final int defaulStandTime = 1;
	public static final int defaulCrouchTime = 1;
}
