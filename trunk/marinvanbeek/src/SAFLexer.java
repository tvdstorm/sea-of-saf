// $ANTLR 3.4 src/SAF.g 2012-01-17 09:39:03
...
public class SAFLexer extends Lexer {
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/SAF.g:99:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+ )
            // src/SAF.g:99:7: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+
            {
            // src/SAF.g:99:7: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+
            int cnt1=0;
            loop1:
    ...
    public void mTokens() throws RecognitionException {
        // src/SAF.g:1:8: ( AND | CURLY_CLOSE | CURLY_OPEN | EQUAL | OR | SQUARE_CLOSE | SQUARE_OPEN | LEVEL | STRING | WHITESPACE )
        int alt3=10;
        switch ( input.LA(1) ) {
        case 'a':
            {
