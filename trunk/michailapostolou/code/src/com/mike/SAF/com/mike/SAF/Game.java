...
//	    	p2.setAnimation("stand",-1,p2Avatar.getLocation());
//	    	p1.setAnimation("kickHigh",1,p1Avatar.getLocation());
    	}
...
//    	Animation animation = new Animation(avatar,name,orientation,avatar.getLocation(),100,new ThreadHandler());
    	int k=0;
//		animation.run();
    }
