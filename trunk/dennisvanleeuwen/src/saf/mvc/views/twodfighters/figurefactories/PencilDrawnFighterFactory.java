...
public class PencilDrawnFighterFactory implements IFigtherFigureFactory {
	...
	@Override
	public IFighterFigure createFighterFigure(FighterModel model) {
		return new PencilFigure(model.getX(), model.getY(), model.getCurrentMoveState(), model.getCurrentFightState());
	}
}