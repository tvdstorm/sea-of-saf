...
public class FightScreen extends JFrame {
	...
	private final Timer timer = new Timer(500, (ActionListener) null);
	...
	public FightScreen() {
		...
		txtFighter1Location.setText("C:\\Workspace_Merlin\\jsaf\\LAB1_referenceImplementation\\src\\jsaf\\test\\jackie.saf");
		...
		txtFighter2Location.setText("C:\\Workspace_Merlin\\jsaf\\LAB1_referenceImplementation\\src\\jsaf\\test\\challenging.saf");
		...
		lblFighter1.setIcon(new ImageIcon(FightScreen.class.getResource("/saf/simulation/graphics/A_stand.png")));
		lblFighter2.setIcon(new ImageIcon(FightScreen.class.getResource("/saf/simulation/graphics/B_stand.png")));
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(FightScreen.class.getResource("/saf/simulation/graphics/background.jpeg")));
	...
	private void timeUpdate() {
		if (engine.Simulate()) {
			...
			lblFighter1.setBounds(
					Math.abs(engine.getFighter1Position() - (fighterBlockSize / 2)), 94, fighterBlockSize,
					fighterBlockSize);
			lblFighter1.setIcon(graphics.getPicture("A_" + engine.getFighter1Stance()));
			lblFighter2.setBounds(
					Math.abs(engine.getFighter2Position() - (fighterBlockSize / 2)), 94, fighterBlockSize,
					fighterBlockSize);
			lblFighter2.setIcon(graphics.getPicture("B_" + engine.getFighter2Stance()));
		} else {
			// end of simulation
